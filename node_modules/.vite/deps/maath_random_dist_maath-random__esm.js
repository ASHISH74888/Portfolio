...
import { Vector3, Matrix3 as Matrix32 } from "three";
...
function rotateVectorOnVector(a, b) {
  ...
  var c = a.dot(b);
  var i = new Matrix32().identity();
  var vx = new Matrix32().set(0, -v.z, v.y, v.z, 0, -v.x, -v.y, v.x, 0);
  var vxsquared = new Matrix32().multiplyMatrices(vx, vx).multiplyScalar(1 / (1 + c));
